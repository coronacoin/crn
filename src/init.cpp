...
std::string HelpMessage()
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: corona.conf)") + "\n";
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: coronad.pid)") + "\n";
    ...
    strUsage += "  -port=<port>           " + _("Listen for connections on <port> (default: 10673 or testnet: 20673)") + "\n";
    ...
    strUsage += "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 10674 or testnet: 20674)") + "\n";
    ...
    strUsage += "\n" + _("SSL options: (see the CORONA Wiki for SSL setup instructions)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // Make sure only a single CORONA process is using the data directory.
